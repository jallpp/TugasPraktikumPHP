    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label for="">Biaya untuk kurir</label>
            ...
            <div class="col-3 mt-3">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Barang :  <?= @$total_item?> </li>
                    <li class="list-group-item">Tanggal : <?= @$tanggal ?>  </li>
                    <li class="list-group-item">Kurir : <?= @$kurir ?> </li>
                    <li class="list-group-item">Alamat : <?= @$alamat ?> </li>
                    <li class="list-group-item">Biaya Kurir : <?= @$biaya_ongkir ?></li>
                    <li class="list-group-item">Jaminan : <?= @$jaminan ?></li>
                    <li class="list-group-item">Total Harga: <?= @$total_price ?></li>
            ...
            <div class="col-3 mt-3">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Kulkas : Rp6.000.000</li>
                    <li class="list-group-item">Mesin Cuci : Rp4.000.000</li>
                </ul>
                </div>
            </div>
